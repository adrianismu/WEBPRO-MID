    ...
    <div class="container px-6 mx-auto">
        <div class="flex justify-center my-6">
            <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
                ...
                @endif
                <h3 class="text-3xl font-bold mb-4">Cart List</h3>
                <div class="flex-1">
                                    ...
                                    <div class="h-10 w-28">
                                        <div class="relative flex flex-row w-full h-8">
                                            <form action="{{ route('cart.update') }}" method="POST">
                                                ...
                                                <button type="submit" class="px-2 ml-2 text-white bg-blue-500">Update</button>
                                            </form>
                                        </div>
                                    </div>
                                </td>
                    ...
                    <div class="flex justify-end items-center mt-6">
                        <div class="text-left pr-6">
                            <span class="text-lg font-semibold">Total Quantity: {{ Cart::getTotalQuantity() }}</span>
                        </div>
                        ...
                        <div>
                            <form action="{{ route('cart.clear') }}" method="POST">
                                @csrf
                                <button class="px-6 py-2 text-red-800 bg-red-300 rounded-lg">Remove All Cart</button>
                            </form>
                        </div>
                    </div>
                </div>
